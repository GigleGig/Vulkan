...
void* _darray_pop_at(void* array, u64 index, void* dest) {
    ...
    if(index != length - 1) {
        kcopy_memory((void*)(addr + (index * stride)), (void*)(addr + (index + 1) * stride), stride * (length - index));
    }
...
void* _darray_insert_at(void* array, u64 index, void* value_ptr) {
    ...
    if(index != length - 1) {
        kcopy_memory((void*)(addr + ((index + 1) * stride)), (void*)(addr + (index * stride)), stride * (length - index));
    }
