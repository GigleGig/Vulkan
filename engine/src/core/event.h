...
/**
 * Register to listen for when events are sent with the provided code. Events with duplicate listener/callback
 * combos will not be registered again and will cause this to return FALSE.
...
/**
 * Unregister to listen for when events are sent with the provided code. If no matching registration is found,
 ...
 * @param sender A pointer to a sender. Can be 0/NULL.
...
typedef enum system_event_code {
    ...
    /** Context usage:
     * u16 mouse_button = data.data.u16[0];
     */
